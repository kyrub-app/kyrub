...
export const CustomerOrderInbox = ({
  ...
  return (
    <section className="space-y-3 rounded-2xl border border-slate-800 bg-slate-900/70 px-2 py-3 sm:space-y-4 sm:rounded-3xl sm:p-5">
      ...
      {replacedFocusOrderId && focusOrderId && (
        <div
          ...
          className="rounded-2xl border border-amber-500/20 bg-amber-500/[0.06] px-3 py-2.5 text-[10px] leading-relaxed text-amber-100"
          role="status"
        >
      ...
      <div className="rounded-xl border border-cyan-500/20 bg-cyan-500/5 p-2 sm:rounded-2xl sm:p-2.5">
        <div className="mb-1.5 flex items-center gap-1.5 px-0.5 text-[8px] font-black uppercase tracking-wide text-cyan-300">
      ...
      <div className="rounded-xl border border-violet-500/20 bg-violet-500/5 p-2 sm:rounded-2xl sm:p-2.5">
        <div className="mb-1.5 flex items-center gap-1.5 px-0.5 text-[8px] font-black uppercase tracking-wide text-violet-300">
