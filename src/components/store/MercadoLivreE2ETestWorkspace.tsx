...
export default function MercadoLivreE2ETestWorkspace({ user, storeId, connectionId, notify }: {
  ...
  const chooseCategory = async (nextCategoryId: string): Promise<void> => {
    ...
    try {
      ...
      setOptions(result);
      setMessage('Opções oficiais carregadas. O Cairube organizou características, disponibilidade, garantia e entrega em etapas; informações opcionais podem ser puladas.');
