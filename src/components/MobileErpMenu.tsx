...
export function MobileErpMenu({
  ...
  const drawerPortal =
    isOpen && isRetailer && typeof document !== 'undefined'
      ? createPortal(
          <div
            className="fixed inset-0 z-[200] isolate pointer-events-auto"
            role="presentation"
          ...
          >
            <button
              ...
              className="absolute inset-0 z-0 pointer-events-auto bg-slate-950/75 backdrop-blur-sm"
            />
            ...
            <aside
              ...
              className="absolute inset-y-0 right-0 z-10 flex w-[82vw] max-w-sm pointer-events-auto animate-fade-in flex-col border-l border-slate-800 bg-slate-900 shadow-2xl"
            >
